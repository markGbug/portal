...
public class ApiModelParamDaoImpl extends BaseDao implements ApiModelParamDao {
	...
	public long add(ApiModelParam apiModelParam) {
		...
		String sql = "INSERT INTO " + model_param_table
		             + "(create_date,modify_date, model_id, param_name, def_value, description, object_id, "
		             + "param_type_id, array_data_type_id, required) "
		             + "VALUES (:createDate, :modifyDate, :modelId, :paramName, :defValue, :description, :objectId, "
		             + ":paramTypeId, :arrayDataTypeId, :required)";
	...
	public int update(ApiModelParam apiModelParam) {
		String sql = "UPDATE " + model_param_table
		             + " SET modify_date=:modifyDate, model_id=:modelId, param_name=:paramName, def_value=:defValue, "
		             + "description=:description, "
		             + " object_id=:objectId, param_type_id =:paramTypeId, array_data_type_id=:arrayDataTypeId, "
