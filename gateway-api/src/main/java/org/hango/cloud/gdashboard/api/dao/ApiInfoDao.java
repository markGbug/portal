...
public interface ApiInfoDao extends IBaseDao<ApiInfo> {
	 ...
	 */
	List<ApiInfo> findAllApiInfoByServiceLimit(long serviceId, long documentStatusId, String pattern, long offset,
	                                           long limit);

	List<ApiInfo> findAllApiInfoByProjectLimit(long projectId, long documentStatusId, String pattern, long offset,
	                                           long limit);
