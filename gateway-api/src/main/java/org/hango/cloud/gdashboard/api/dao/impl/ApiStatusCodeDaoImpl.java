...
public class ApiStatusCodeDaoImpl extends BaseDao implements ApiStatusCodeDao {
	...
	public long add(ApiStatusCode apiStatusCode) {
		...
		String sql = "insert into " + apiStatusCodeTable
		             + " (create_date, modify_date, error_code, message, status_code, object_id, type, description)"
		             + " values (:createDate, :modifyDate, :errorCode, :message, :statusCode, :objectId, :type, "
		             + ":description)";
	...
	public int update(ApiStatusCode apiStatusCode) {
		String sql = "update " + apiStatusCodeTable
		             + " set modifyDate = :modifyDate, error_code = :errorCode, message = :message, object_id = "
		             + ":objectId"
