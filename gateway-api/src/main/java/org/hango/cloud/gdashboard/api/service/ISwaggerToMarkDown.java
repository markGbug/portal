...
public interface ISwaggerToMarkDown {
	...
	String generateArrayString(Entry<String, JSONObject> arrayMap, String subString, String requiredFlag,
	                           Map<String, Object> definitionsMap, Stack<String> subParameterStringList, long id);
