...
public class ApiHeaderDaoImpl extends BaseDao implements ApiHeaderDao {
	...
	public long add(ApiHeader apiHeader) {
		...
		String sql = "INSERT INTO " + header_param_table
		             + "(create_date, modify_date, api_id, param_name, param_value, description, type) "
	...
	public int update(ApiHeader apiHeader) {
		String sql = "UPDATE " + header_param_table
		             + " SET modify_date=:modifyDate, param_name=:paramName, param_value=:paramValue, "
