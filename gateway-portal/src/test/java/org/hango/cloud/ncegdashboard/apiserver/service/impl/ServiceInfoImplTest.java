...
public class ServiceInfoImplTest extends BaseServiceImplTest {
	...
	public void findAllServiceByProjectIdLimit() {
		serviceInfoService.add(serviceInfo);
		List<ServiceInfo> allServiceByProjectIdLimit = serviceInfoService.findAllServiceByProjectIdLimit(
			serviceName.trim(), 0, 20, projectId);
	...
	public void getServiceByServiceNameAndProject() {
		serviceInfoService.add(serviceInfo);
		ServiceInfo serviceByServiceNameAndProject = serviceInfoService.getServiceByServiceNameAndProject(serviceName,
		                                                                                                  projectId);
