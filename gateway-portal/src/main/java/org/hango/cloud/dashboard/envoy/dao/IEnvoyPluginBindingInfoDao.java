...
public interface IEnvoyPluginBindingInfoDao extends IBaseDao<EnvoyPluginBindingInfo> {
	 ...
	 */
	long getBindingPluginCount(long projectId, long gwId, List<Long> gwIdList, String bindingObjectId,
	                           List<String> bindingObjectIdList, List<String> bindingObjectTypeList, String pattern);
	 ...
	 */
	List<EnvoyPluginBindingInfo> getBindingPluginList(long projectId, long gwId, List<Long> gwIdList,
