...
public class EnvoyServiceProxyInfo {
	...
	public static EnvoyServiceProxyInfo fromDto(EnvoyServiceProxyDto envoyServiceProxyDto) {
		EnvoyServiceProxyInfo envoyServiceProxyInfo = BeanUtil.copy(envoyServiceProxyDto, EnvoyServiceProxyInfo.class);
		if (envoyServiceProxyDto.getSubsets() != null) {
			envoyServiceProxyInfo.setSubsets(JSON.toJSONString(envoyServiceProxyDto.getSubsets()));
		}
		envoyServiceProxyInfo.setCode(
			envoyServiceProxyDto.getPublishType() + "-" + envoyServiceProxyDto.getServiceId());
