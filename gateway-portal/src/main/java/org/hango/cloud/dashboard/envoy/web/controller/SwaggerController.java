...
public class SwaggerController extends AbstractController {
	...
	public void getServicesDocs(@RequestParam(value = "ServiceId") @NotNull long serviceId)
		...
		Swagger swagger = new Swagger().info(info).scheme(Scheme.HTTP).consumes("application/json").produces(
			"application/json");
	...
	public void getInterfacesDocs(@RequestParam(value = "InterfaceId") @NotNull long interfaceId)
		throws JsonProcessingException {
	...
	public Object getApiMarkDownDocs(@RequestParam(value = "InterfaceId") @NotNull long interfaceId)
		...
		String markDownDoc = swaggerToMarkDown.swaggerToMd(swagger, interfaceId, apiStatusCodeList, 1).get(
			"markDownDoc");
	 ...
	 * 通过接口id下载markdown
	 */
	@RequestMapping(params = {"Action=DownloadMarkdownApiById"}, method = RequestMethod.GET,
	                produces = "application/octet-stream;charset=UTF-8")
	public Object downloadApiMarkDownDocs(@RequestParam(value = "InterfaceId") @NotNull long interfaceId)
		throws JsonProcessingException, Exception {
		logger.info("获取apiId:{}下的接口markdown", interfaceId);
	 ...
	 * 通过服务id，下载markdown
	 */
	@RequestMapping(params = {"Action=DownloadMarkdownServiceById"}, method = RequestMethod.GET,
	                produces = "application/octet-stream;charset=UTF-8")
	...
	public String getMarkDownDocsByServiceId(long serviceId) {
		...
		for (ApiInfo apiInfo : apiInfoList) {
			...
			Map<String, String> apiMarkDownMap = swaggerToMarkDown.swaggerToMd(swagger, apiInfo.getId(),
			                                                                   apiStatusCodeList, id);
