...
public class RouteRuleMatchInfo {
	...
	public boolean isSame(RouteRuleMatchInfo routeRuleInfo) {
		return getPriority() == routeRuleInfo.getPriority() && getOrders() == routeRuleInfo.getOrders() && Objects
			                                                                                                   .equals(
				                                                                                                   getUri(),
				                                                                                                   routeRuleInfo
					                                                                                                   .getUri())
		       && Objects.equals(getMethod(), routeRuleInfo.getMethod()) && Objects.equals(getHost(),
		                                                                                   routeRuleInfo.getHost())
		       && Objects.equals(getHeader(), routeRuleInfo.getHeader()) && Objects.equals(getQueryParam(),
		                                                                                   routeRuleInfo
			                                                                                   .getQueryParam());
	}
