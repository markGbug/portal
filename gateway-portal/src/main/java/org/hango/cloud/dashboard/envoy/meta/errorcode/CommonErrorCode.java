...
public class CommonErrorCode extends ErrorCode {
	...
	public static ErrorCode MissingParameterParamMatchingMode = new ErrorCode(ErrorCodeEnum.MissingParameter,
	                                                                          "ParamMatchingMode");

	public static ErrorCode MissingParameterServiceName = new ErrorCode(ErrorCodeEnum.MissingParameter, "ServiceName");

	public static ErrorCode MissingParameterQueryTime = new ErrorCode(ErrorCodeEnum.MissingParameter,
	...
	public static ErrorCode MissingParameterRegistryCenterAddr = new ErrorCode(ErrorCodeEnum.MissingParameter,
	                                                                           "RegistryCenterAddr");

	public static ErrorCode MissingParameterApplicationName = new ErrorCode(ErrorCodeEnum.MissingParameter,
	                                                                        "ApplicationName");
	...
	public static ErrorCode InvalidModulusShuntInstanceList = new ErrorCode(
		ErrorCodeEnum.InvalidModulusShuntInstanceList);
	...
	public static ErrorCode InvalidConsistentHashHttpCookieObject = new ErrorCode(
		ErrorCodeEnum.InvalidConsistentHashHttpCookieObject);

	public static ErrorCode InvalidConsistentHashHttpCookieName = new ErrorCode(
		ErrorCodeEnum.InvalidConsistentHashHttpCookieName);

	public static ErrorCode InvalidConsistentHashHttpCookieTtl = new ErrorCode(
		ErrorCodeEnum.InvalidConsistentHashHttpCookieTtl);

	public static ErrorCode InvalidConsistentHashHttpHeaderName = new ErrorCode(
		ErrorCodeEnum.InvalidConsistentHashHttpHeaderName);

	public static ErrorCode InvalidConsistentHashSourceIP = new ErrorCode(ErrorCodeEnum.InvalidConsistentHashSourceIP);

	//-----------------------Envoy 网关部分ErrorCode-------------------//

	public static ErrorCode InvalidHttp1MaxPendingRequests = new ErrorCode(
		ErrorCodeEnum.InvalidHttp1MaxPendingRequests);
	...
	public static ErrorCode InvalidMaxRequestsPerConnection = new ErrorCode(
		ErrorCodeEnum.InvalidMaxRequestsPerConnection);
	...
	public static ErrorCode InvalidLoadBalanceRuleId(long loadBalanceRuleId) {
		return new ErrorCode(ErrorCodeEnum.InvalidParameterValue, "LoadBalanceRuleId",
		                     String.valueOf(loadBalanceRuleId));
	}
