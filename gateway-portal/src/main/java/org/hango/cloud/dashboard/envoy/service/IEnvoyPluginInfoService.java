...
public interface IEnvoyPluginInfoService {
	 ...
	 * @param bindingObjectType   插件绑定对象类型
	 * @param pluginType          插件类型
	 * @param pluginConfiguration 插件配置
	 * @param projectId           项目id
	 * @param templateId          关联模板id
	 *
	 * @return {@link ErrorCodeEnum#Success} ErrorCodeEnum.Success
	 */
	ErrorCode checkBindingPlugin(long gwId, String bindingObjectId, String bindingObjectType, String pluginType,
	 ...
	 */
	boolean bindingPlugin(long gwId, String bindingObjectId, String bindingObjectType, String pluginType,
	                      String pluginConfiguration, long projectId, long templateId);
	 ...
	 */
	List<EnvoyPluginBindingInfo> getEnablePluginBindingList(long gwId, String bindingObjectId,
	 ...
	 * @return 指定对象上绑定的插件数量
	 */
	long getBindingPluginCount(long gwId, long projectId, String bindingObjectId, List<String> bindingObjectTypeList,
	                           String pattern);
	 ...
	 */
	List<EnvoyPluginBindingInfo> getBindingPluginList(long gwId, long projectId, String bindingObjectId,
	                                                  List<String> bindingObjectTypeList, String pattern, long offset,
	                                                  long limit, String sortKey, String sortValue);
