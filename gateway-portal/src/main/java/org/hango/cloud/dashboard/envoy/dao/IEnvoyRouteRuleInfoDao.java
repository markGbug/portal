 ...
 * 2019-09-11
 */
public interface IEnvoyRouteRuleInfoDao extends IBaseDao<EnvoyRouteRuleInfo> {
	 ...
	 *
	 * @return {@link List<EnvoyRouteRuleInfo>} 路由规则
	 */
	List<EnvoyRouteRuleInfo> getRuleInfoByLimit(String pattern, int publishStatus, long projectId, String sortKey,
	 ...
	 */
	List<EnvoyRouteRuleInfo> getRuleInfoByServiceLimit(String pattern, int publishStatus, long serviceId,
